                ...
                <Card className="w-full md:w-1/2 border-none shadow-none">
                    <CardHeader className="space-y-1">
                        <div className="flex justify-center mb-4">
                            <div
                                className="w-16 h-16 bg-gradient-to-br from-red-500 to-amber-500 rounded-2xl flex items-center justify-center">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        className="sr-only">{showPassword ? "隐藏密码" : "显示密码"}</span>
                                                </Button>
                                            </div>
                                        </div>
                                    </CardContent>
                                ...
                                <form onSubmit={(e) => handleSubmit(e, "register")}>
                                    <CardContent className="space-y-4">
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground"/>
                                                <Input id="register-email" type="email" placeholder="请输入邮箱"
                                                       className="pl-10" required/>
                                            </div>
                                        </div>
                                        <div className="space-y-2">
