    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-2xl mx-auto">
        ...
        <FormField
          ...
          name="tags"
          render={({ field }) => (
            <FormItem className="flex border">
              <FormLabel className="w-28 leading-none">
        ...
        <FormItem className="flex">
          <FormLabel className="w-28">文章封面</FormLabel>
          <div>
            <FormControl>
              <div
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex">
              <FormLabel className="w-28">收录至专栏</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex">
              <FormLabel className="w-28">创作话题</FormLabel>
              <FormControl>
