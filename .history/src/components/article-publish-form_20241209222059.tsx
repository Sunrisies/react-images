    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 max-w-2xl mx-auto">
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex '>
              <FormLabel className="w-40">分类<span className="text-red-500">*</span></FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex">
              <FormLabel className='w-40'>添加标签<span className="text-red-500">*</span></FormLabel>
              <FormControl>
                <Input
        ...
        <FormItem className="flex">
          <FormLabel className='w-40'>文章封面</FormLabel>
          <div>
          <FormControl>
            <div 
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex'>
              <FormLabel className='w-40'>收录至专栏</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex'>
              <FormLabel className='w-40'>创作话题</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='flex'>
              <FormLabel className='w-40'>编辑摘要<span className="text-red-500">*</span></FormLabel>
              <FormControl>
